...
int ft_is_wall_x(t_mlx *mlx, int x)
{
...
int ft_is_wall_y(t_mlx *mlx, int y)
{
...
int	ft_key_press(int code, t_mlx *mlx)
{
	...
	if (code == 65307)
		ft_mlx_destroy(mlx);
	else if (code == 100 && !ft_is_wall_y(mlx, mlx->y_player + 1))
		mlx->y_player = mlx->y_player + 1;
	else if (code == 97 && !ft_is_wall_y(mlx, mlx->y_player - 1))
		mlx->y_player = mlx->y_player - 1;
	else if (code == 119 && !ft_is_wall_x(mlx, mlx->x_player - 1))
		mlx->x_player = mlx->x_player - 1;
	else if (code == 115 && !ft_is_wall_x(mlx, mlx->x_player + 1))
		mlx->x_player = mlx->x_player + 1;
  ft_render(mlx);
	return (0);
}
